...
from lib.HiPerformer import hiPerformer
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'Synapse': {
            'Dataset': dataset,
            'volume_path': '/home/xzp/dataset/Synapse/test',
            'list_dir': '/home/xzp/dataset/Synapse/list',
            'num_classes': 9,
            'z_spacing': 1,
        },
    }
    ...
    args.exp = 'HiPerformer_' + dataset_name + str(args.img_size)
    snapshot_path = "./checkpoint/{}".format(args.exp)
    ...
    net = hiPerformer(num_classes=args.num_classes).to(args.device)



    # if not os.path.exists(snapshot): snapshot = snapshot.replace('best_model', 'epoch_'+str(args.max_epochs-1))
    snapshot_path = '/home/xzp/dbsy/Synapse/PerformerV2/checkpoint/PerformerV2_Synapse224_epo300_bs16_lr0.0001_224/'
